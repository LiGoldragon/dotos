...
NOTA must be quotation-safe. A whole NOTA expression must be able to sit inside a
...
strings: NOTA never emits a double-quote, so nesting a NOTA value inside a
